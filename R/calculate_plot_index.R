#' Calculate plot indices for points in 2D space
#'
#' Function that returns plot numbers for given coordinate pairs. E.g. for
#' hectares res = 100 m.
#'
...
#'
#' @return Plot number for the input point.
#'
#' @export
calculate_plot_index <- function(xcor, ycor, res = 1,
                                 minx = NA, miny = NA, maxx = NA, maxy = NA,
                                 exclude.maxx = T) {
